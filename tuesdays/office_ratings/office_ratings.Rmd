...
pos + neg + plot_annotation(title='IMDB ratings of the Office are not impacted by word sentiment',subtitle='but more positive words are used then negative ones') + ggsave('office_ratings_vs_word_sentiment.pdf',width=6,height=3) + plot_layout(guides = 'collect') 
